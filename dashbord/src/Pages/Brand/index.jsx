...
import { FiPlus } from 'react-icons/fi' // اضافه کردن آیکون مثبت برای زیبایی دکمه
...
export default function Brand() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto space-y-6" dir="rtl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
        <div>
          <h3 className="text-xl font-bold text-gray-800">
            مدیریت برندهای محصول
          </h3>
          <p className="text-sm text-gray-500 mt-1">
            لیست، ویرایش و افزودن برندهای تجاری محصولات در این بخش انجام می‌شود.
          </p>
        </div>
      ...
      {/* بخش نمایش فرزندان (فرم ایجاد یا لیست برندها) */}
